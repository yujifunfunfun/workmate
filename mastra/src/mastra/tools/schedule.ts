  ...
  execute: async ({ context }) => {
    ...
    const schedules: { [key: string]: string[] } = {
      testuser: [
        ...
        "木曜日: 8:00-10:00 朝作業, 10:00-11:00 1on1ミーティング, 11:00-13:00 ドキュメント作成, 14:00-15:00 障害対応訓練, 15:00-16:30 勉強会, 16:30-18:30 個人開発時間",
      ...
      testuser2: [
        ...
        "木曜日: 8:00-9:00 朝活動チェック, 9:00-10:00 部門MTG, 10:00-13:00 キャンペーン企画, 14:00-16:00 トレーニングセッション, 16:00-18:00 メディア対応準備, 18:00-19:00 デイリーレポート確認",
      ...
      testuser3: [
        ...
        "木曜日: 8:00-8:30 デイリープランニング, 8:30-10:00 進捗確認MTG, 10:00-11:00 資料作成, 11:00-13:00 共同研究ミーティング準備, 14:00-15:00 データセット検証, 15:00-17:30 論文執筆, 17:30-19:00 研究ノート整理",
...
// 月曜日の15:00-16:00と木曜の13:00-14:00のみ空いてる
